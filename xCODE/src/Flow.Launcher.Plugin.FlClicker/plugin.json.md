# plugin.json
The mandatory plugin.json file in the project's root folder is THE manifest files of your plugin.
 It is required for Flow to understand how to communicate with your plugin. 
